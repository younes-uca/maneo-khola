...
@Component({
  selector: 'app-mode-acces-edit-admin',
  templateUrl: './mode-acces-edit-admin.component.html'
})
export class ModeAccesEditAdminComponent extends AbstractEditController<ModeAccesDto, ModeAccesCriteria, ModeAccesAdminService>   implements OnInit {
